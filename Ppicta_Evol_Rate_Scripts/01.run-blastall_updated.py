...
def exec_commands(cmds, max_threads):
    ...
    while True:
        ...
        while cmds and len(processes) < max_threads:
            task = cmds.pop()
...
def main():
    ...
    exec_commands(makeblastdb, max_threads=args.processors)

    # Passes the makeblastrun commands (a list of lists) to the exec_commands
    # function and executes them in parallel.
    exec_commands(makeblastrun, max_threads=args.processors)
